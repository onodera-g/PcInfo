...
from constants import CARD_WIDTH, ICON_DISK, ANIMATION_DURATION
...
def display_storage_log_content(
    ...
    if not disk_data:
        ...
        icon_path = get_icon_path(ICON_DISK)
        label_width = 120
...
def display_storage_diagnostics_with_dialog(page: ft.Page) -> None:
    ...
    try:
        result = storage_diagnostics.get_CrystalDiskInfo_log()
        if result:
